...
void iteration(double _num){
	...
	SimuParams test_params(num_par, //Number of particles.							keep
		...
		0.001,						//Simulation timestep.(ms)							keep
	...
	Lattice test_lattice(3.0, 3.0, 0.5, 100.0, 100.0, 0, 2);
	...
	Cylinder_XY test_primitive_1(Vector3(1, 0, 0), 0.9, 0.2, 0.0, 0.0,100.0/1000.0 , 1, 0, num_par);		//the diffusion coefficient must be a float point
	test_scanner.add_primitive(test_primitive_1);

/*
	Cylinder_XY test_primitive_nose(Vector3(0, 1, 0), 1, 0.2, 0.0, 0.0, 0.004, 1, 0, num_par);
	...
	Cylinder_XY test_primitive_mouth_2(Vector3(-0.60, 1.25, 0), 0.25, 0.2, 0.5, 1.0, 0.001, 1, 0, num_par);
	test_scanner.add_primitive(test_primitive_mouth_2);
	Cylinder_XY test_primitive_mouth_3(Vector3(0, 1.4, 0), 0.25, 0.2, 0.5, 1.0, 0.002, 1, 0, num_par);
	test_scanner.add_primitive(test_primitive_mouth_3);
	Cylinder_XY test_primitive_mouth_4(Vector3(0.60, 1.25, 0), 0.25, 0.2, 0.5, 1.0, 0.003, 1, 0, num_par);
	test_scanner.add_primitive(test_primitive_mouth_4);
	Cylinder_XY test_primitive_mouth_5(Vector3(1.25, 1, 0), 0.25, 0.2, 0.5, 1.0, 0.004, 1, 0, num_par);
