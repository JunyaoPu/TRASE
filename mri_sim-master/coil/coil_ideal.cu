...
////////////////////////////////
__device__ __host__ Vector3 Coil_Ideal::getField(const Sequence* sequence, Vector3 r, real time,int seg,int pulse_num) const{   //demo JUNYAO optimization
//	return sequence->getG(r, time , seg,pulse_num);
}
