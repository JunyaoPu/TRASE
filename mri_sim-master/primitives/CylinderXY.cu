...
__device__ __host__ bool Cylinder_XY::intersect(const Vector3 & ri, const Vector3 & rf, real & v, Vector3 & n) const{
	...
	printf("Cylinder_XY::intersect is called########################################(JUNYAO)\n");
...
__device__ __host__ Vector3 Cylinder_XY::getNormal(const Vector3 & r) const{
	...
	printf("Cylinder_XY::getNormal is called########################################(JUNYAO)\n");
...
__device__ __host__ real Cylinder_XY::getRadius() const{
	...
	printf("Cylinder_XY::getRadius is called########################################(JUNYAO)\n");

	return radius;

}

__device__ __host__ int Cylinder_XY::getRegion(const Vector3 & r) const{					//called in happy face

//	printf("Cylinder_XY::getRegion is called########################################(JUNYAO)\n");
...
__device__ __host__  real Cylinder_XY::getT2(const Vector3 & r) const{
	...
	printf("Cylinder_XY::getT2 is called########################################(JUNYAO)\n");
...
__device__ __host__ real Cylinder_XY::getD(const Vector3 & r) const{
	...
	printf("Cylinder_XY::getD is called########################################(JUNYAO)\n");
	if (inside(r)){
		return D;
	}
	return -1.0;
...
__host__ void Cylinder_XY::setRadius(real _r){
	...
	printf("Cylinder_XY::setRadius is called########################################(JUNYAO)\n");
	radius = _r;
}

__host__ void Cylinder_XY::setEPS(real _cylEPS){
	printf("Cylinder_XY::setEPS is called########################################(JUNYAO)\n");
	cylEPS = _cylEPS;
}

__host__ void Cylinder_XY::setRegion(int _region){
	printf("Cylinder_XY::setRegion is called########################################(JUNYAO)\n");
	region = _region;
}
...
__device__ void Cylinder_XY::randUnif(Vector3 & r, curandState & localState) const{
	printf("Cylinder_XY::randUnif is called########################################(JUNYAO)\n");
...
__host__ void Cylinder_XY::randUnif(Vector3 & r) const{
	printf("Cylinder_XY::randUnif2 is called########################################(JUNYAO)\n");
