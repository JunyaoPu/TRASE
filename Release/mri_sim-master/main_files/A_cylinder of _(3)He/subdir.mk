...
mri_sim-master/main_files/A_cylinder\ of\ _(3)He/Iteration.o: ../mri_sim-master/main_files/A_cylinder\ of\ _(3)He/Iteration.cu
	...
	/usr/local/cuda-9.1/bin/nvcc -I/usr/local/cuda/lib64/ -I/home/graphics/Dev/external_sources/cub-1.7.4 -I/home/junyao/Documents/cub-1.7.4 -O3 -std=c++11 -gencode arch=compute_61,code=sm_61  -odir "mri_sim-master/main_files/A_cylinder of _(3)He" -M -o "$(@:%.o=%.d)" "$<"
